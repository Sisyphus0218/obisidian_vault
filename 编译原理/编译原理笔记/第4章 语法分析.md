...
![compile-4-1](assets/compile-4-1.png)

![compile-4-2](assets/compile-4-2.png)
...
![compile-4-3](assets/compile-4-3.png)

$if$ $E_1$ $then$ $if$ $E_2$  $then$ $S_1$ $else$ $S_2$ 有两棵语法分析树

![compile-4-4](assets/compile-4-4.png)
...
![compile-4-5](assets/compile-4-5.png)
...
![compile-4-6](assets/compile-4-6.png)
...
![compile-4-7](assets/compile-4-7.png)
...
![compile-4-22](assets/compile-4-22.png)
...
$A\rightarrow ab$ | $a$  
输入串 $w=cad$  
![compile-4-8](assets/compile-4-8.png)
...
![compile-4-9](assets/compile-4-9.png)
...
![compile-4-12](assets/compile-4-12.png)
...
![compile-4-13](assets/compile-4-13.png)
...
![compile-4-14](assets/compile-4-14.png)

![compile-4-15](assets/compile-4-15.png)
...
![compile-4-16](assets/compile-4-16.png)

eg. 

![compile-4-17](assets/compile-4-17.png)

![compile-4-18](assets/compile-4-18.png)

![compile-4-19](assets/compile-4-19.png)
...
![compile-5-46](assets/compile-5-46.png)
...
![compile-4-20](assets/compile-4-20.png)

它们是 $E+T*$ 的有效项

![compile-4-21](assets/compile-4-21.png)
...
可行前缀的新定义  
项 $[A\rightarrow \alpha \cdot \beta,a]$ 对于可行前缀 $\delta \alpha$ 有效的条件：  

1. 存在一个推导过程 $S\stackrel{*}{\Rightarrow}_{rm} \delta A \omega \Rightarrow_{rm} \delta \alpha \beta \omega$
...
对于 $[A\rightarrow \alpha \cdot B \beta,a]$，将 $[B\rightarrow \cdot \gamma,b]$ 加入闭包，其中 $b$ 属于 FIRST($\gamma a$)
...
![compile-5-47](assets/compile-5-47.png)

![compile-5-48](assets/compile-5-48.png)

![compile-5-49](assets/compile-5-49.png)
...
![compile-5-50](assets/compile-5-50.png)

![compile-5-51](assets/compile-5-51.png)
